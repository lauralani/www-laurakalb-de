    ...
    render() {
        return (
          ...
          unter diesem Text aufgeführten Datenschutzerklärung.</p>
                ...
                können Sie
          im weiteren Verlauf dieser Seite entnehmen.</p>
          ...
          zu.</p>
                <p>Hierzu sowie zu weiteren Fragen zum Thema Datenschutz können Sie sich jederzeit unter der untenstehend
          angegebenen Adresse an uns wenden.</p>
                ...
                allem mit
          Cookies und mit sogenannten Analyseprogrammen.</p>
          ...
          Webseitenzugriffe und sonstige Daten, die über eine Website generiert werden, handeln.</p>
                <p>Der Einsatz des Hosters erfolgt zum Zwecke der Vertragserfüllung gegenüber unseren potenziellen
                und
          ...
          erforderlich ist und unsere Weisungen in Bezug auf diese Daten befolgen.</p>
                ...
                <p>Content Delivery Networks werden eingesetzt um eine bessere Aufrufzeiten international zu erreichen.
                Obwohl die Server in West Europa stehen, kann es daher vorkommen, dass je nach Aufrufsort, die Anfragen
                von Servern außerhalb Europas verarbetet werden.
      </p>
          ...
          Auftragsverarbeitung mit unserem Hoster geschlossen. <a href="http://www.microsoftvolumelicensing.com/Downloader.aspx?DocumentId=13871">Bestimmungen für
              Onlinedienste</a></p>
          ...
          Widerruf unberührt.</p>
                ...
                PERSONENBEZOGENEN
                DATEN NICHT MEHR VERARBEITEN, ES SEI DENN, WIR KÖNNEN ZWINGENDE SCHUTZWÜRDIGE GRÜNDE
                FÜR DIE
          ...
          Adresse an uns wenden.</p>
                ...
                Hierzu
                können Sie sich jederzeit unter der angegebenen Adresse an uns wenden. Das Recht auf
          Einschränkung der Verarbeitung besteht in folgenden Fällen:</p>
                <ul>
                    ...
                    benötigen wir
                    in der Regel Zeit, um dies zu überprüfen. Für die Dauer der Prüfung haben Sie
                    das Recht,
          ...
          Union oder eines Mitgliedstaats verarbeitet werden.</p>
                ...
                Ihrem
                Endgerät gespeichert, bis Sie diese selbst löschen&nbsp;oder eine automatische Lösung
                durch Ihren
          ...
          Videos). Andere Cookies dienen dazu, das Nutzerverhalten auszuwerten&nbsp;oder Werbung anzuzeigen.</p>
                ...
                zur
                Bereitstellung bestimmter, von Ihnen erwünschter Funktionen (funktionale Cookies, z. B. für
                die
          ...
          hierzu müssen die Server-Log-Files erfasst werden.</p>
                ...
                <p>Diese Website nutzt zu Analysezwecken <a href="https://clarity.microsoft.com">Microsoft Clarity</a></p>
                <p>Anbieter ist die
                Microsoft
                Corporation
          One Microsoft Way, Redmond, WA 98052, USA.</p>
                <p><a href="https://docs.microsoft.com/en-us/clarity/faq">Weitere Informationen</a></p>
                <h3>Azure Application Insights</h3>
                <p>Diese Website nutzt die Analysedienste von Microsoft Azure Application Insights. Anbieter ist die
                Microsoft
                Corporation
                One Microsoft Way, Redmond, WA 98052, USA.
          Im Rahmen der Analysen mit <a href="https://docs.microsoft.com/de-de/azure/azure-monitor/app/app-insights-overview">Application
              Insights</a> können u. a. Besucherzahlen
          und –verhalten (z.&nbsp;B. Anzahl der Seitenaufrufe, Dauer eines Webseitenbesuchs, Absprungraten),
          Besucherquellen (d. h., von welcher Seite der Besucher kommt), Besucherstandorte sowie technische Daten
          (Browser- und Betriebssystemversionen) analysiert werden. Folgende Daten werden erhoben:</p>
                <ul>
                ...
                <p>Application Insights verwendet unter anderem Cookies um eine Analyse des Verhaltens, bzw der Benutzung
                der
                Webseite durch Sie zu ermöglichen.
      </p>
                <p>Die durch das Cookie erzeugte Informationen werden in der Regel an einen Server von Microsoft in West
                Europa
                übertragen und dort gespeichert. Ich habe die Möglichkeit diese Daten über verschiedene Reports
          auszuwerten.</p>
                <p>Weitere Informationen zur Datenerfassung und Verarbeitung entnehmen Sie folgenden
          Links:</p>
                <p><a href="https://azure.microsoft.com/de-de/support/trust-center/privacy/">https://azure.microsoft.com/de-de/support/trust-center/privacy/</a><br />
                    <a href="https://docs.microsoft.com/de-de/azure/application-insights/app-insights-data-retention-privacy">https://docs.microsoft.com/de-de/azure/application-insights/app-insights-data-retention-privacy</a>
                </p>
                <p><strong>Auftragsverarbeitung</strong></p>
                <p>Microsoft hat technische und organsiatorische Sicherheitsmaßnahmen getroffen und eingeführt. Dies soll
                den
          datenschutzkonformen Umgang mit Ihren personenbezogenen Daten durch Microsoft sicherstellen. <a href="http://www.microsoftvolumelicensing.com/Downloader.aspx?DocumentId=13871">Bestimmungen für
              Onlinedienste</a></p>
